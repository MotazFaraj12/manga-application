...
public class MyLoadingButton extends RelativeLayout{
     ...
     */
    public int DEFAULT_LOADER_COLOR = getResources().getColor(R.color.lavender);
    public int DEFAULT_BUTTON_COLOR = getResources().getColor(R.color.lavender);
    ...
    public void initView() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.my_loading_button_layout, this);
